...
namespace FoodDAL.Migrations
{
    ...
    [Migration("20251025204400_CreateDb")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FoodDAL.Models.Auth.AppUser", b =>
                {
            ...
            modelBuilder.Entity("FoodDAL.Models.Cart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FoodDAL.Models.Cart", b =>
                {
                    b.HasOne("FoodDAL.Models.Item", "Items")
                        .WithMany()
            ...
            modelBuilder.Entity("FoodDAL.Models.Item", b =>
                {
                    b.HasOne("FoodDAL.Models.Category", "Categories")
                        .WithMany()
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FoodDAL.Models.SubCategory", "SubCategories")
                        .WithMany()
            ...
            modelBuilder.Entity("FoodDAL.Models.Order.OrderDetails", b =>
                {
                    ...
                    b.HasOne("FoodDAL.Models.Order.OrderHeader", "OrderHeaders")
                        .WithMany()
            ...
            modelBuilder.Entity("FoodDAL.Models.Order.OrderHeader", b =>
                {
                    b.HasOne("FoodDAL.Models.Auth.AppUser", "AppUsers")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("FoodDAL.Models.Auth.AppUser", null)
                        .WithMany()
